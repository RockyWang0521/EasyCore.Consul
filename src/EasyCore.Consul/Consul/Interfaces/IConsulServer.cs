namespace EasyCore.Consul.Servers
{
    public interface IConsulServer
    {
        ...
        /// <param name="apiAddr">api地址</param>
        /// <returns></returns>
        Task<ConsulReturn<TReturn>> ServicePost<TReturn, TParams>(RequestType type, string serviceNamein, string apiAddr, string? token = null);
        ...
        /// <param name="apiAddr">api地址</param>
        /// <returns></returns>
        Task<ConsulReturn<TReturn>> ServicePut<TReturn, TParams>(RequestType type, string serviceNamein, string apiAddr, string? token = null);
